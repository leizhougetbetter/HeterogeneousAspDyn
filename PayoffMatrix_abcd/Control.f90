...
program main
    ...
    !!!! defaut setting:
    !!!! the number of time steps in total is 2*10^7
    !!!! and the sampling of stationary disbribution is started at 1*10^7
    ...
    totalNumLoopSimulation = 2
    generationNumPerLoop = 10000000
    sampleStartLoopIndex = 1
    !!
