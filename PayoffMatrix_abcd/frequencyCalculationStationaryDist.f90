subroutine frequencyCalculationStationaryDist(timesRepeated)
    ...
    real(8)::AAvalue, SSValue
    character(5)::AAvalueStr, SSvalueStr
    ...
    AA_Loop: do AAvalue = AABeg, AAEnd + 0.001, AAGap
            ...
            open(unit = 121,file = "numA_Dist"//"_AA_"//trim(adjustl(AAvalueStr)))
            !!!
            timeRepeatedOneRealization:do indexRepeated=1, timesRepeated
                ...
                !!!! output the distribution of the number of A-players for N=1000
                write(121,"(1001(1X,I10))") numADist
                !!!
